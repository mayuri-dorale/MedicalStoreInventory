...
public class ViewSuppliers extends JFrame {
   ...
   public ViewSuppliers() {
      ...
      this.title = new JLabel("Suppliers List", 0);
      ...
      try {
         ...
         try {
            ...
            ResultSet var3 = var2.executeQuery("SELECT * FROM supplier");
            DefaultTableModel var4 = new DefaultTableModel();
            var4.setColumnIdentifiers(new String[]{"ID", "Supplier Name", "Email", "Company Name"});
            ...
            while(true) {
               ...
               var4.addRow(new Object[]{var3.getInt("id"), var3.getString("name"), var3.getString("email"), var3.getString("comName")});
            }
